...
bool
EnumGenerator::Generate (std::ostream &os)
{
    return MakeBindFunction (os);
}

bool
EnumGenerator::MakeBindFunction (std::ostream &os)
{
...
bool
EnumGenerator::CallBindFunction (std::ostream &os)
{
...
bool
EnumGenerator::make_bind_function (std::ostream &os)
{
    os << endi << "//" << std::string (118, '-') << endi << "// Bind specialization for enum " << m_full_type << endi
       << "//" << std::string (118, '-') << endi << "template <>" << endi << "void bind<" << m_full_type
       << ">(sol::state& lua)" << endi;
...
bool
EnumGenerator::call_bind_function (std::ostream &os)
{
...
std::string
EnumGenerator::make_namespace (std::string where, std::ostream &os)
{
...
std::string
EnumGenerator::make_namespace (std::string where, const std::string &name, std::ostream &os)
{
...
void
EnumGenerator::make_type (const std::string &where, std::ostream &os)
{
    os << where << ".new_enum<" << m_full_type << '>' << '(' << '"' << m_type << '"' << ',' << utils::indent << '{'
       << utils::indent;

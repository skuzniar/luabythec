...
bool MessageGenerator::Generate(std::ostream& os)
{
    return MakeBindFunction(os);
}

bool MessageGenerator::MakeBindFunction(std::ostream& os)
{
    make_bind_function(os);
    return true;
}

bool MessageGenerator::CallBindFunction(std::ostream& os)
{
    call_bind_function(os);
    return true;
}

bool MessageGenerator::make_bind_function(std::ostream& os)
{
    os << endi
       << "//" << std::string(118, '-') << endi
       << "// Bind specialization for message " << m_descriptor->name() << endi
       << "//" << std::string(118, '-') << endi
       << "template <>" << endi
...
bool MessageGenerator::call_bind_function(std::ostream& os)
{
    os << "bind<" << m_full_type << ">(lua);";
    return true;
}

std::string MessageGenerator::make_namespace(std::string where, std::ostream& os)
{
...
std::string MessageGenerator::make_namespace(std::string where, const std::string& name, std::ostream& os)
{
...
std::string MessageGenerator::make_type(const std::string& where, std::ostream& os)
{
...
bool MessageGenerator::make_accessors(const std::string& where, std::ostream& os)
{
